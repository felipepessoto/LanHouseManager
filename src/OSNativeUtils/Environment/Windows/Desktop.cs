...
namespace LanManager.OSNativeUtils.Environment.Windows
{
    /// <summary>
    ...
    public class Desktop : IDisposable, ICloneable
    {
        ...
        public System.Diagnostics.Process CreateProcess(string path)
        {
            // make sure object isnt disposed.
            CheckDisposed();
        ...
        public static System.Diagnostics.Process CreateProcess(string path, string desktop)
        {
        ...
        public static System.Diagnostics.Process[] GetInputProcesses()
        {
            // get all processes.
            ...
            System.Diagnostics.Process[] procs = new System.Diagnostics.Process[m_procs.Count];

            for (int i = 0; i < procs.Length; i++) procs[i] = (System.Diagnostics.Process)m_procs[i];
